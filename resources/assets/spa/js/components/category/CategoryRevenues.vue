<template>
    <div class="row">
        <page-title>
            <h5>Administração de categorias (Receitas)</h5>
        </page-title>
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            getCategories() {
                CategoryRevenues.query().then(response => {
                    this.categories = response.data.data;
                    this.formatCategories();
                });
            },
            saveCategory(){
                CategoryService.save(CategoryRevenues, this.categorySave, this.parent, this.categories, this.category).then((response)=>{
            ...
            destroy() {
                CategoryService.destroy(CategoryRevenues, this.categoryDelete, this.parent, this.categories).then(response => {
