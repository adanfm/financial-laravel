...
$factory->define(\CodeFin\Models\CategoryExpenses::class, function (Faker\Generator $faker) {
    return  [
        'name'  =>  $faker->name
    ];
});

$factory->define(\CodeFin\Models\CategoryRevenues::class, function (Faker\Generator $faker) {
    return  [
        'name'  =>  $faker->name
    ];
});